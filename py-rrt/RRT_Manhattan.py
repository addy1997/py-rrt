# Author: Adwait Naik @addy1997 | Created on: 13/01/2019
#!/usr/bin/python
# -*- coding: utf-8 -*-
...
def init_obstacles(configNum):  # initialized the obstacle
    ...
    if configNum == 0:
        rectObs.append(pygame.Rect((XDIM / 2.0 - 50, YDIM / 2.0 - 100),
                       (100, 200)))
    if configNum == 1:
    ...
    while True:
        if currentState == 'init':
            ...
            if count < NUMNODES:
                ...
                nodes.append(Node(newnode, parentNode, dist(newnode,
                             parentNode.point) + parentNode.cost))
