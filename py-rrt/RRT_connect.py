# Author: Adwait Naik @addy1997 | Created on: 11/01/2019
#!/usr/bin/python
# -*- coding: utf-8 -*-
    ...
    for yi in range(lines):
        for xi in range(columns):
            if level[yi][xi] == 'x':  # wall
                rectObs.append(pygame.Rect((length * xi, height * yi),
                               (length, height)))
        ...
        if currentState == 'init':
            ...
            while currNode.parent != None:
                pygame.draw.line(screen, red, currNode.point,
                                 currNode.parent.point, 2)
                currNode = currNode.parent
            while currNode1.parent != None:
                pygame.draw.line(screen, navy, currNode1.point,
                                 currNode1.parent.point, 2)
            ...
            if count < NUMNODES:
                ...
                while foundNext == False:
                    ...
                    parentNode = nodes[0]
                    for p in nodes:
                        if chebyshev_dist(p.point, rand) \
                            <= chebyshev_dist(parentNode.point, rand):
                ...
                pygame.draw.line(screen, olive, parentNode.point,
                                 newnode)
                foundNext1 = False
                while foundNext1 == False:
                    ...
                    for p in nodes1:
                        if chebyshev_dist(p.point, rand1) \
                            <= chebyshev_dist(parentNode1.point, rand1):
                ...
                pygame.draw.line(screen, dblue, parentNode1.point,
                                 newnode2)
                reached = False
                collide = False
                while reached == False and collide == False:
                    ...
                    if collides(newnode4) == False:
                        newnode5 = Node(newnode4, nodes1[len(nodes1)
                                - 1])
                        nodes1.append(newnode5)
                        pygame.draw.line(screen, dblue, newnode3.point,
                                newnode4)
                        newnode3 = newnode5
                        if newnode4 == rand1:
                            reached = True
                ...
                if currentState == 'init':
                    if initPoseSet == False:
                        ...
                        if collides(e.pos) == False:
                            ...
                            initPoseSet = True
                            pygame.draw.circle(screen, olive,
                        ...
                        if collides(e.pos) == False:
                            ...
                            goalPoseSet = True
                            pygame.draw.circle(screen, navy,
